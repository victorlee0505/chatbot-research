...
FIELDS_METADATA_AUTHOR = "author"
FIELDS_METADATA_CONTENT_TYPE = "content_type"
...
def _get_search_client(
    ...
    try:
        ...
        fields = [
            ...
            # ),
            # SearchableField(
            #     name=FIELDS_METADATA_CONTENT_TYPE,
            #     type=SearchFieldDataType.String,
            #     searchable=True,
            #     retrievable=True,
            # ),
            # SearchableField(
            #     name=FIELDS_METADATA_CREATION_DATE,
            #     type=SearchFieldDataType.String,
            #     searchable=True,
            #     retrievable=True,
            # ),
            # SearchableField(
            #     name=FIELDS_METADATA_LAST_MODIFIED,
            #     type=SearchFieldDataType.String,
            #     searchable=True,
            #     retrievable=True,
            # ),
...
class AzureCognitiveSearch(VectorStore):
    ...
    def as_retriever(self, **kwargs: Any) -> AzureCognitiveSearchVectorStoreRetriever:
        return AzureCognitiveSearchVectorStoreRetriever(vectorstore=self, **kwargs)
