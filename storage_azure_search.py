...
index_name: str = "langchain-vector-demo1"
...
query = "outils pour le développement de logiciels"
...
results1 = db.vector_search(query, k=3, kwargs={"filters": "bullshit1 eq 'Developer Tools'"})

results2 = db.hybrid_search(query, k=3, kwargs={"filters": "bullshit2 eq 'Developer Tools'"})

results3 = db.semantic_hybrid_search(query, k=3, filters="category eq 'Developer Tools'")
