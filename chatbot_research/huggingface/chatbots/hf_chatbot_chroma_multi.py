...
# class HuggingFaceChatBotChromaPdr:
#     # initialize
#     def __init__(
#         self,
...
#         else:
#             print(f"disable_mem: {self.disable_mem}")
#             self.qa = create_history_aware_retriever(
#                 llm=self.llm,
#                 chain_type="stuff",
#                 retriever=retriever,
#                 memory=memory,
...
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=REDPAJAMA_3B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=REDPAJAMA_7B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=VICUNA_7B, disable_mem=True)

#     bot = HuggingFaceChatBotChromaPdr(llm_config=OPENORCA_MISTRAL_8K_7B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=OPENORCA_MISTRAL_7B_Q5, disable_mem=True, gpu=True, gpu_layers=10)

#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_7B)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_16K_7B)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_LONGCHAT_1_5_32K_7B)

#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_7B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_16K_7B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_LONGCHAT_1_5_32K_7B, disable_mem=True)

#     # GGUF Quantantized LLM, use less RAM
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_7B_Q8, disable_mem=True, gpu_layers=10) # mem = 10GB
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_16K_7B_Q8, disable_mem=True, gpu_layers=10) # mem = 10GB

#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_13B_Q6, disable_mem=True, gpu_layers=10) # mem = 18GB
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=LMSYS_VICUNA_1_5_16K_13B_Q6, disable_mem=True, gpu_layers=0) # mem = 18GB

#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_3B, disable_mem=True)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_15B_Q8, disable_mem=True, gpu_layers=10) # mem = 23GB
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_PY_7B, disable_mem=True, gpu_layers=10)
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_PY_7B_Q6, disable_mem=True, gpu_layers=10) # mem = 9GB
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_PY_13B_Q6, disable_mem=True, gpu_layers=10) # mem = 14GB
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDCODER_PY_34B_Q5, disable_mem=True, gpu_layers=10) # mem = 27GB
    
#     # This one is not good at all
#     # bot = HuggingFaceChatBotChromaPdr(llm_config=WIZARDLM_FALCON_40B_Q6K, disable_mem=True, gpu_layers=10) # mem = 45GB
